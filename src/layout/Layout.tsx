      ...
      <main className="w-full font-poppins">
        <section id='home' className="w-full min-h-svh flex items-center pt-16 overflow-hidden">
          <div className="container mx-auto flex gap-12">
              ...
              <div className="w-full h-full flex flex-col gap-3 justify-center" data-aos="fade-up" >
                ...
                <div className="w-full flex items-center gap-3">
                  <a
                    ...
                    target="_blank"
                    className="text-xl text-white hover:drop-shadow hover:drop-shadow-light-blue hover:scale-110 transition-all duration-300"
                  >
                    <FaFacebookF />
                  </a>
                  <a
            ...
            {/* FOTO */}
            <div className="w-1/2 h-[550px] relative flex justify-center items-center" data-aos="fade-up" >
        ...
        <section id='about_me' className="w-full min-h-[550px] bg-dark-blue flex justify-center items-center py-16">
          <div className="container mx-auto flex items-center gap-6">
            <div className="w-1/2 flex flex-col gap-6" data-aos="fade-right">
              <h2 className="uppercase text-white font-poppins font-medium text-6xl">
            ...
            <div className="w-1/2 flex justify-center items-center relative overflow-hidden" data-aos="fade-left" >
              <svg viewBox="0 0 500 500" className="size-[600px]">
                <path
        ...
        <section className="w-full bg-dark-blue border-t border-t-white/5">
          <div className="container mx-auto pt-16 pb-32" data-aos="fade-up">
            <Marquee>
              <img
                src="/technology/nestjs.webp"
                alt="NestJs"
                title="Nestjs"
                className="w-[300px] h-20 object-center object-contain grayscale-100 opacity-50 hover:grayscale-0 transition-all duration-500 hover:opacity-100 hover:drop-shadow hover:drop-shadow-red-500"
              />
              <img
                src="/technology/typescript.webp"
                alt="Typescript"
                title="Typescript"
                className="w-[300px] h-20 object-center object-contain grayscale-100 opacity-50 hover:grayscale-0 transition-all duration-500 hover:opacity-100 hover:drop-shadow hover:drop-shadow-sky-500"
              />
              <img
              ...
              <img
                ...
                alt="Figma"
                title="Figma"
                className="w-[300px] h-20 object-center object-contain grayscale-100 opacity-50 hover:grayscale-0 transition-all duration-500 hover:opacity-100  hover:drop-shadow hover:drop-shadow-white"
              />
              <img
                src="/technology/ubuntu.webp"
                alt="Ubuntu"
                title="Ubuntu"
                className="w-[300px] h-20 object-center object-contain grayscale-100 opacity-50 hover:grayscale-0 transition-all duration-500 hover:opacity-100 hover:drop-shadow hover:drop-shadow-orange-400"
              />
              <img
                src="/technology/nodejs.webp"
                alt="NodeJs"
                title="NodeJs"
                className="w-[300px] h-20 object-center object-contain grayscale-100 opacity-50 hover:grayscale-0 transition-all duration-500 hover:opacity-100 hover:drop-shadow hover:drop-shadow-green-400"
              />
              <img
        ...
        <section className="w-full flex justify-center items-center py-16">
          <div className="container mx-auto h-[350px] flex gap-12 items-end">
            <CardKnowledge
        ...
        <section className="w-full bg-dark-blue py-16 flex justify-center items-center">
          <div className="container mx-auto flex justify-center items-center relative">
            <h2 className="font-poppins text-4xl font-semibold text-center text-white" data-aos="zoom-in">
        ...
        <section id='contact' className="w-full flex justify-center items-center py-16">
          <div className="container mx-auto flex flex-col gap-9">
            ...
            <div className="w-full flex gap-6">
              <form className="w-1/2 flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)} data-aos="fade-up">
              ...
              <div className="w-1/2 flex flex-col gap-9" data-aos="fade-up">
        ...
        <footer className="w-full flex justify-center items-center bg-dark-blue py-6">
          <h3 className="font-light text-white text-center container">
            © 2025 Fabian Bermudez Tapia | Todos los derechos reservados
          </h3>
        </footer>
      </main>
    </>
